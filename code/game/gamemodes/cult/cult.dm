...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "MoMMI")
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
...
/datum/game_mode/cult/generate_report()
	return "Some stations in your sector have reported evidence of blood sacrifice and strange magic. Ties to the Wizards' Federation have been proven not to exist, and many employees \
			...
			devoted to stopping this cult. Note that holy water seems to weaken and eventually return the minds of cultists that ingest it, and loyalty implants will prevent conversion \
			altogether."
