 ...
 **/
  ...
  *
  * return datum/nanoui The found UI.
 **/
/datum/controller/subsystem/nanoui/proc/try_update_ui(mob/user, datum/src_object, ui_key, datum/nanoui/ui, force_open = FALSE)
  ...
  * return datum/nanoui The found UI.
 **/
/datum/controller/subsystem/nanoui/proc/get_open_ui(mob/user, datum/src_object, ui_key)
 ...
 **/
/datum/controller/subsystem/nanoui/proc/update_uis(datum/src_object)
	var/src_object_key = "[REF(src_object)]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
 ...
 **/
/datum/controller/subsystem/nanoui/proc/close_uis(datum/src_object)
	var/src_object_key = "[REF(src_object)]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
		return 0 // Couldn't find any UIs for this object.
...
/datum/controller/subsystem/nanoui/proc/close_all_uis()
  ...
  * return int The number of UIs updated.
 **/
/datum/controller/subsystem/nanoui/proc/update_user_uis(mob/user, datum/src_object = null, ui_key = null)
  ...
  * return int The number of UIs closed.
 **/
/datum/controller/subsystem/nanoui/proc/close_user_uis(mob/user, datum/src_object = null, ui_key = null)
	if(isnull(user.open_uis) || !istype(user.open_uis, /list) || open_uis.len == 0)
		return 0 // Couldn't find any UIs for this user.
 ...
 **/
/datum/controller/subsystem/nanoui/proc/on_open(datum/nanoui/ui)
 ...
 **/
/datum/controller/subsystem/nanoui/proc/on_close(datum/nanoui/ui)
	var/src_object_key = "[REF(ui.src_object)]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
  ...
  * return int The number of UIs closed.
 **/
/datum/controller/subsystem/nanoui/proc/on_logout(mob/user)
 ...
 **/
/datum/controller/subsystem/nanoui/proc/on_transfer(mob/source, mob/target)
